		...
		unsigned char reg, unsigned char val)
{
	...
	if (err < 0) {
		dev_err(&client->dev, "i2c write error\n");
                sprintf(debug_msg, "in lm3533.c reg=%02X val=%02X\n", reg, val);
		dev_err(&client->dev, debug_msg);
        }
	return 0;
}
...
static char mapped_value[256] = {
        110,110,111,111,112,113,113,114,114,115,115,116,116,117,117,
	118,118,119,119,120,121,122,123,124,125,126,127,128,129,130,
	131,132,133,134,136,137,138,140,141,142,144,145,146,147,148,
